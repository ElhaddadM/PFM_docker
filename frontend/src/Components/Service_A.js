            ...
            <div>
                ...
                <MDBModal staticBackdrop tabIndex='-1' show={staticModal} setShow={setStaticModal}>
                    <MDBModalDialog>
                        <MDBModalContent>
                            <MDBModalHeader>
                                <MDBModalTitle> Inscription </MDBModalTitle>
                            ...
                            <MDBModalFooter>
                                <div className={footerM.btnsA}>
                                    <MDBBtn color='secondary' className='me-2 px-4' onClick={()=>{ toggleShow();;sessionStorage.removeItem('RDV'); window.location.reload() }}>
                                        Fermer
                                    </MDBBtn>
